...
<div x-data="setup()" x-init="$refs.loading.classList.add('hidden');" @resize.window="watchScreen()">
      <div class="flex h-screen antialiased text-gray-900 md:bg-white dark:bg-dark dark:text-light  mb-6">
        ...
        <div class="m-4">
            ...
            <h3 class="font-medium bg-indigo-300 font-bold text-black text-left px-6 p-6"><a href="{{ url()->previous() }}" class="bg-red-600 p-2 font-bold text-black pl-6 pr-3 rounded-lg">Back</a> Notification ID #{{ $previewNotification->id }}</h3>
                <div class="mt-5 w-full text-sm">
                    <div class="p-4 bg-white border rounded-lg shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-200">
                        <div class="grid items-center justify-between mb-4">
                            <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-black">{{ $previewNotification->subject }}</h5>
                        </div>
                        <div class="flow-root">
