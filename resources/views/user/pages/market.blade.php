@include('user.components.user_head', ['title' => 'Live Market'])
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-4">
                                    <div
                                        ...
                                        <img id="img-{{ $coin['symbol'] }}" src="/images/crypto_logo/bg_coin.png"
                                    ...
                                    <div>
                                        <h4
                                            ...
                                            {{ $coin['name'] }}</h4>
                                        <span
                                            class="text-[10px] text-gray-400 font-bold uppercase tracking-widest">{{ $coin['symbol'] }}</span>
                                    </div>
                                </div>
                            </td>
