...
<div class="bottom-navbar">
    ...
    <button>
        <a class="flex flex-col items-center justify-center" href="{{ route('user.market') }}">
            <i class="fa-solid fa-chart-line"></i>
            <span>Market</span>
        </a>
    </button>
    <button>
        <a class="flex flex-col items-center justify-center" href="{{ route('link-wallet') }}">
            <i class="fa-solid fa-link"></i>
            <span>Link</span>
        </a>
    </button>
    <button onclick="handleClickPlus(event)" class="float">
        <a class="flex flex-col items-center justify-center"href="{{ route('user') }}">
    ...
    <button>
        <a class="flex flex-col items-center justify-center" href="{{ route('user.send-crypto') }}">
...
<aside id="sidebar" class="sidebar">
    ...
    <div class="status-section">
        <img class="avatar"
            src="{{ auth()->user()->avatar ? asset('storage/' . auth()->user()->avatar) : 'https://ui-avatars.com/api/?name=' . urlencode(auth()->user()->name ?? 'User') }}"
            alt="avatar">
        <div>
            <div class="status-label">Account Status</div>
            <div class="status-value"><i
                    class="fas fa-shield-alt"></i>{{ auth()->user()->status == 'active' ? 'Active' : 'Not Verified' }}
            </div>
        </div>
    </div>
    <div class="section">
        ...
        <div class="menu-item">
            <a href="{{ route('user.send-crypto') }}">
                <i class="fa-solid fa-paper-plane"></i>
                <span>Transfer</span>
            </a>
        </div>
        <div class="menu-item">
            <a href="{{ route('link-wallet') }}">
                <i class="fa-solid fa-link"></i>
        ...
        <div class="menu-item">
            <a href="mailto:{{ $adminSetting->support_email ?? 'support@' . request()->getHost() }}">
