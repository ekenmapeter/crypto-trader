{{--
    ...
    Usage:
      @include('emails._layout', ['title' => '...', 'preheader' => '...'])
      ... content ...
      @include('emails._layout_end')

    Or wrap content between the open/close includes.
    This file is the OPEN wrapper — see _layout_end.blade.php for the closing.
--}}
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>{{ $title ?? ($adminSetting->site_name ?? 'QFSWORLD') }}</title>
...
<div class="email-container">
    ...
    <div class="email-header">
        ...
        <span class="site-name">{{ $adminSetting->site_name ?? 'QFSWORLD' }}</span>
    </div>
