...
<head>
    <meta charset="utf-8" />
    <title>Register | {{ $adminSetting->site_name ?? 'Moonbond' }}</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-6">
                        <div class="card mt-4">
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Get your free {{ $adminSetting->site_name ?? 'Moonbond' }} account now</p>
                                </div>
                                <div class="p-2 mt-4">
                                    <form method="POST" action="{{ route('register') }}" id="register-form">
                                        ...
                                        <div class="step-panel active" id="step-1">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="phone" class="form-control" id="phone" placeholder="Enter phone number" value="{{ old('phone') }}" required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                @error('country') <span class="text-danger fs-12">{{ $message }}</span> @enderror
                                            </div>
                                            <div class="mb-3">
                                                <label for="referral_code" class="form-label">Referral Code (Optional)</label>
                                                <input type="text" name="referral_code" class="form-control" id="referral_code" placeholder="Enter referral code" value="{{ old('referral_code', request('ref')) }}">
                                            </div>
                                            <div class="mt-4">
                                        ...
                                        <div class="step-panel" id="step-2">
                                            ...
                                            <div class="form-check mb-3">
                                                ...
                                                <label class="form-check-label fs-12" for="terms">I agree to the <a href="{{ route('terms-conditions') }}">Terms & Conditions</a></label>
                                            </div>
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0 text-white-50">Already have an account? <a href="{{ route('login') }}" class="fw-semibold text-decoration-underline text-primary"> Sign In </a> </p>
                        </div>
                    </div>
                </div>
            </div>
