          ...
          <section>
            <div class="md:flex grid-cols-1 md: w-1/2 lg:1/2 w-1/2 items-center md:h-12 md:p-8 m-6 p-4 bg-violet-400 shadow rounded-lg">
               ...
               <div class="mt-0 md:m-12 m-2">
                <h3 class="mt-6 text-xl m-6">All </h3>
              <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
              <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                <div class="overflow-hidden border-b border-gray-200 rounded-md shadow-md">
                  <a href="/create-new-subcard/{{ $subId }}" class="bg-blue-700 p-2 text-sm rounded text-white float-right md:mr-8 mr-2 mb-6">Add New Category</a>
                  <table class="min-w-full overflow-x-scroll divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr class="transition-all hover:bg-indigo-300 hover:shadow-lg">
                          <td class="md:px-6 px-2 py-2 md:py-4 whitespace-nowrap">
                            <div class="flex items-center">
                              ...
                              <div class="ml-4">
                                <div class="text-sm font-medium text-gray-900">{{ $data->card_country_name }}</div>
                              </div>
                            </div>
                          </td>
                          <td class="md:px-6 px-2 py-2 md:py-4 whitespace-nowrap">
                            <div class="text-sm text-xs text-gray-900">
                              <div class="text-sm text-center font-medium text-gray-900">{{ $data->card_country_rate }}</div>
                            </div>
                          </td>
                          <td class="md:px-6 px-2 py-2 md:py-4 whitespace-nowrap">
                            <div class="text-sm text-xs text-gray-900">
                              <a href="/edit-subcard/{{ $data->id }}" class="block text-white bg-blue-700 rounded text-center py-2 px-4">Edit Card</a>
                            </div>
                          </td>
                      ...
                      @empty
                    <div>
                        <h3 class="text-red-400 font-extrabold">No Sub Card Available</h3>
