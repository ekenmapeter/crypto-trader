...
<head>
    ...
    <title>419 — Page Expired | QFSWORLD</title>
    ...
    <style>
        ...
        *::after {
        ...
        @keyframes icon-spin {
            ...
            50% {
                box-shadow: 0 0 30px 8px rgba(245, 158, 11, 0.15);
            }
...
<body>
    ...
    <div class="card">
        ...
        <p class="error-msg">
            Your session has expired or the page's security token is no longer valid.
    ...
    <script>
        ...
        (function() {
            ...
            for (let i = 0; i < 30; i++) {
                ...
                p.style.cssText =
                    `width:${s}px;height:${s}px;left:${Math.random()*100}vw;top:${Math.random()*100}vh;animation:float-up ${Math.random()*15+8}s linear ${Math.random()*6}s infinite;`;
                c.appendChild(p);
            }
        })();
    </script>
