<?php echo $__env->make('user.components.user_head', ['title' => $title ?? 'Deposit'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div x-show="step === 2" x-transition.opacity.duration.300ms style="display: none;">
                <div class="grid md:grid-cols-2 gap-8">
                    ...
                    <div class="bg-gray-50/50 p-6 rounded-[20px] border border-gray-100 h-fit">
                        <form action="<?php echo e(route('user.deposit.store')); ?>" method="post" enctype="multipart/form-data" class="space-y-6">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\Coin-trade\resources\views/user/pages/deposit.blade.php ENDPATH**/ ?>