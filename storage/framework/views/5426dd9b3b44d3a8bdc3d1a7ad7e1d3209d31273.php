    ...
    <header class="bg-white border-b border-gray-200 sticky top-0 z-30">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
            <div class="flex items-center space-x-4">
                <a href="<?php echo e(route('user')); ?>" class="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center hover:bg-gray-200 transition-all">
            ...
            <div class="lg:col-span-12">
                <div class="bg-white rounded-[32px] border border-gray-200 shadow-sm overflow-hidden p-8 md:p-12 mb-8">
                    ...
                    <div class="mt-12 pt-12 border-t border-gray-100 flex flex-col items-center">
                        <div class="bg-blue-600 hover:bg-blue-700 text-white rounded-[20px] px-10 py-5 font-bold text-lg shadow-xl shadow-blue-100 transition-all hover:scale-[1.02] cursor-pointer inline-flex items-center space-x-3" onclick="window.location.href='<?php echo e(route('coin-wallet')); ?>'">
                ...
                <div class="bg-gray-900 rounded-[32px] p-8 md:p-10 text-white relative overflow-hidden shadow-2xl">
                    <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                        <div>
                            ...
                            <h2 class="text-4xl md:text-5xl font-black mt-2 tracking-tighter">$<?php echo e(number_format($totalWalletAmount, 2)); ?></h2>
                            <p class="text-gray-400 mt-2">Aggregated from <?php echo e(count(auth()->user()->userWallets)); ?> internal crypto assets</p>
                        </div>
                        <div class="w-full md:w-auto flex flex-col space-y-3">
                            <div class="bg-white/10 backdrop-blur-md rounded-2xl p-4 flex items-center justify-between gap-8">
                                ...
                                <span class="font-bold text-xl">$<?php echo e(number_format($totalWalletAmount, 2)); ?></span>
                            </div>
...
<?php /**PATH C:\xampp\htdocs\Coin-trade\resources\views/user/pages/link-wallet.blade.php ENDPATH**/ ?>