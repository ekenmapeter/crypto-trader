<header class="bg-gradient-to-r from-[#0a3d91] to-[#1258c4] p-6 flex justify-between items-center relative shadow-lg">
    <div>
        ...
        <h1 class="text-xl font-bold"><?php echo e(auth()->user()->username); ?></h1>
    </div>
    <div class="relative">
...
<?php /**PATH C:\xampp\htdocs\Coin-trade\resources\views/user/components/top-navbar.blade.php ENDPATH**/ ?>