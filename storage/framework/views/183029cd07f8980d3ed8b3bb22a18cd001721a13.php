...
<div class="min-h-screen bg-gray-50 text-gray-900 font-sans">
    ...
    <div class="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-gray-100 px-6 py-4">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            <a href="<?php echo e(route('user')); ?>" class="flex items-center space-x-3 group px-4 py-2 hover:bg-gray-50 rounded-2xl transition-all duration-300">
            ...
            <div class="flex items-center space-x-4">
                <div class="hidden md:flex flex-col items-end mr-4">
                    ...
                    <span class="text-sm font-black text-gray-900"><?php echo e(auth()->user()->username); ?></span>
                </div>
            ...
            <?php $__currentLoopData = $activeWalletProvider; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                >
                    ...
                    <div class="relative z-10 flex flex-col items-center text-center">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors"><?php echo e($type->title); ?></h3>
