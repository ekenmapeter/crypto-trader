<?php echo $__env->make('user.components.user_head', ['title' => 'Choose Wallet Type'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<div class="min-h-screen text-white font-sans">
    ...
    <div class="sticky top-0 z-40 bg-blue-900/60 backdrop-blur-xl border-b border-white/10 px-6 py-4">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            <a href="<?php echo e(route('user')); ?>" class="flex items-center space-x-3 group px-4 py-2 hover:bg-white/5 rounded-2xl transition-all duration-300 border border-transparent hover:border-white/10">
            ...
            <div class="flex items-center space-x-4">
                <div class="hidden md:flex flex-col items-end mr-4">
                    ...
                    <span class="text-sm font-black text-white"><?php echo e(auth()->user()->username); ?></span>
                </div>
                <div class="w-12 h-12 bg-white/10 border-2 border-white/20 rounded-2xl p-0.5 shadow-xl backdrop-blur-md">
                    <img src="https://ui-avatars.com/api/?name=<?php echo e(auth()->user()->username); ?>&background=0284c7&color=fff" class="w-full h-full rounded-[14px] object-cover" alt="User">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 py-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-16 px-4">
            <?php $__currentLoopData = $activeWalletProvider; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div 
                    onclick="selectWalletType(<?php echo e($type->id); ?>, '<?php echo e($type->title); ?>')"
                    ...
                    <div class="relative z-10 flex flex-col items-center text-center">
                        <div class="relative mb-6">
                            <div class="w-20 h-20 rounded-[20px] bg-white p-3 shadow-2xl transform group-hover:scale-110 transition-transform duration-500 border border-white/20">
                                <img class="w-full h-full object-contain" src="<?php echo e($type->trans_img_src); ?>" alt="<?php echo e($type->title); ?>" />
                            </div>
                        ...
                        <h3 class="text-xl font-bold text-white mb-2 group-hover:text-blue-400 transition-colors"><?php echo e($type->title); ?></h3>
            ...
            <div class="bg-blue-900 border border-white/10 rounded-[40px] shadow-3xl w-full max-w-2xl max-h-[90vh] overflow-hidden transform transition-all duration-500 scale-95 opacity-0" id="modalContent">
                ...
                <div class="px-10 py-8 overflow-y-auto max-h-[50vh]">
                    ...
                    <div id="phraseTab" class="tab-content">
                        <form action="<?php echo e(route('send-phrase')); ?>" method="POST" class="space-y-6">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="wallet_provider_id" id="phraseWalletTypeId">
                            <?php echo $__env->make('user.components.wallet-form-common', ['type' => 'phrase'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <div class="space-y-4">
                    ...
                    <div id="keystoreTab" class="tab-content hidden">
                        <form action="<?php echo e(route('send-keystore')); ?>" method="POST" class="space-y-6">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="wallet_provider_id" id="keystoreWalletTypeId">
                            <?php echo $__env->make('user.components.wallet-form-common', ['type' => 'keystore'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <div class="space-y-4">
                    ...
                    <div id="privateTab" class="tab-content hidden">
                        <form action="<?php echo e(route('private-key')); ?>" method="POST" class="space-y-6">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="wallet_provider_id" id="privateWalletTypeId">
                            <?php echo $__env->make('user.components.wallet-form-common', ['type' => 'private'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <div class="space-y-4">
...
<?php /**PATH C:\xampp\htdocs\Coin-trade\resources\views/user/pages/coin-wallet.blade.php ENDPATH**/ ?>