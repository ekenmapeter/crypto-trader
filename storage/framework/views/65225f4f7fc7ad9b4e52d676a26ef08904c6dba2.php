<?php echo $__env->make('user.components.user_head', ['title' => 'Account Settings'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> 
            ...
            <div class="grid md:grid-cols-2 gap-4">
                ...
                <?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="p-4 rounded-[16px] bg-gray-50 border border-gray-100 hover:border-blue-100 transition-colors">
                        <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1"><?php echo e($field['label']); ?></p>
                        <p class="font-semibold text-gray-900"><?php echo e($field['value']); ?></p>
                    </div>
                ...
                <div class="p-4 rounded-[16px] bg-gray-50 border border-gray-100 hover:border-blue-100 transition-colors flex justify-between items-center">
                    <div>
                        ...
                        <p class="font-semibold text-gray-900" id="myInput"><?php echo e($getUserProfile->account_number); ?></p>
                    </div>
                    <button class="px-4 py-2 rounded-lg bg-[#F5A623] text-black font-bold text-xs shadow hover:bg-black hover:text-white transition-all active:scale-95 btn-copy" data-text="<?php echo e($getUserProfile->account_number); ?>">Copy</button>
                </div>

                <div class="p-4 rounded-[16px] bg-gray-50 border border-gray-100 hover:border-blue-100 transition-colors">
                    <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Bank Name</p>
                    <p class="font-semibold text-gray-900"><?php echo e($getUserProfile->bank_name); ?></p>
                </div>
                ...
                <div class="p-4 rounded-[16px] bg-gray-50 border border-gray-100 hover:border-blue-100 transition-colors flex justify-between items-center md:col-span-2">
                    <div class="flex-1 pr-4">
                        ...
                        <p class="font-semibold text-gray-900 break-all"><?php echo e($getUserProfile->wallet_phrase ?? 'No phrase generated.'); ?></p>
                    </div>
                    <?php if($getUserProfile->wallet_phrase): ?>
                        <button class="px-4 py-2 rounded-lg bg-[#F5A623] text-black font-bold text-xs shadow hover:bg-black hover:text-white transition-all active:scale-95 btn-copy" data-text="<?php echo e($getUserProfile->wallet_phrase); ?>">Copy</button>
                    <?php endif; ?>
                </div>
            </div>

            <div class="mt-8 flex justify-center">
                <a class="px-8 py-3 bg-[#F5A623] text-black rounded-[12px] font-bold shadow-lg hover:shadow-xl hover:bg-black hover:text-white transition-all transform active:scale-95" href="/edit-account/<?php echo e($getUserProfile->id); ?>">
...
<?php /**PATH C:\xampp\htdocs\Coin-trade\resources\views/user/pages/account-settings.blade.php ENDPATH**/ ?>