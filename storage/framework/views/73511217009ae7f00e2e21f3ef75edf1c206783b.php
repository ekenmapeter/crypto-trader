...
<head>
    <meta charset="utf-8" />
    <title>Login | <?php echo e($adminSetting->site_name ?? 'Moonbond'); ?></title>
                        ...
                        <div class="card mt-4">
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to continue to <?php echo e($adminSetting->site_name ?? 'Moonbond'); ?>.</p>
                                </div>
                                <div class="p-2 mt-4">
                                    <div class="alert bg-light text-center">
                                        <small class="fs-6 text-white">Please make sure you are visiting</small>
                                        <p class="text-white mb-0"><span class="text-success"><i class="ri-lock-2-fill align-bottom"></i> https://</span><?php echo e(request()->getHost()); ?></p>
                                    </div>
                                    <form method="POST" action="<?php echo e(route('login')); ?>">
                                        <?php echo csrf_field(); ?>
                                        <div class="mb-3">
                                            <label for="login" class="form-label">Email or Username</label>
                                            <input type="text" name="login" class="form-control" id="login" placeholder="Enter email or username" value="<?php echo e(old('login')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0 text-white-50">Don't have an account? <a href="<?php echo e(route('register')); ?>" class="fw-semibold text-decoration-underline text-primary"> Sign Up </a> </p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <?php if(session('status')): ?>
        <script>
            Swal.fire({ title: 'Success', text: "<?php echo e(session('status')); ?>", icon: 'success' });
        </script>
    <?php endif; ?>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\Coin-trade\resources\views/auth/login.blade.php ENDPATH**/ ?>